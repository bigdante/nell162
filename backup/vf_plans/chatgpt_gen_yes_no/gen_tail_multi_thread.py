...
if __name__ == '__main__':
    # mode = "baseline"
    mode = "alias"
    base_file_path = "./train_auto_glm_data/baseline/query_data" if mode == "baseline" else "./train_auto_glm_data/alias/query_data"
    out_file_path = "./train_auto_glm_data/baseline/query_result" if mode == "baseline" else "./train_auto_glm_data/alias/query_result"
